"""
Django settings for test_3_5 project.
...
WSGI_APPLICATION = 'test_3_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_3_5 API",
    "DESCRIPTION": "API documentation for test_3_5 App",
    "VERSION": "v1",
}
